        ...
        <div class="chat">
            <div class="chat-header clearfix">
                ...
                <div class="chat-about">
                    <div v-if="userMessage.user" class="chat-with">Chat with {{ userMessage.user.name }}
                    ...
                    <div v-else>
                        <h5><b>Select A Friend To Start Conversation</b></h5>
                    </div>
                </div>
                    ...
                    <li class="clearfix" v-for="message in userMessage.messages" :key="message.id">
                        <div class="message-data align-right">
                            ...
                            <ul class="nav" style="display:inline-block">
                                <li class="nav-item dropdown">
                                    <a class="nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"><b>...</b></a>
                                    <div class="dropdown-menu">
            ...
            <div class="chat-message clearfix">
                <textarea v-if="userMessage.user" @keydown.enter.prevent="sendMessage" v-model="message" name="message-to-send" id="message-to-send" placeholder="Type your message"></textarea>
                <textarea v-else disabled placeholder="Type your message"
                    rows="3"></textarea>
